/**
 * UI Module - Handles all DOM rendering and UI updates for Minifigures
 */
...
const UI = {
    ...
    /**
     * Create HTML for a single item card (minifigure only)
    ...
    getFormData() {
        const formData = {
            ...
            figureNumber: document.getElementById('itemNumber').value.trim(),
