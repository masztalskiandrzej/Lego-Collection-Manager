/**
 * Storage Module - Firestore ONLY for Minifigures Collection Manager
 *
...
const Storage = {
    ...
    async initFirestore() {
        ...
        console.log('🔥 Firestore Storage initialized for Minifigures collection');
    ...
    async addItem(item) {
        ...
        return { ...item, id, type: 'minifigure' };
    },
    ...
    async loadSampleData(sampleData) {
        ...
        if (sampleData && sampleData.length > 0) {
            const minifigsData = sampleData.map(item => ({ ...item, type: 'minifigure' }));
            await this.firestoreStorage.loadSampleData(minifigsData);
        }
        return true;
    },
