...
(function () {
    ...
    const translations = {
        pl: {
            ...
            'form.marketValue': 'Wartość rynkowa ($)',
            'form.beCheck': '💰 Sprawdź',
            'card.be': 'Zobacz wartość na BrickEconomy',
            'dash.marketValue': 'wartość rynkowa',
            'dash.compareTitle': 'Rynek vs cena zakupu',
            'dash.purchaseSum': 'Suma cen zakupu',
            'dash.marketSum': 'Wartość rynkowa',
            'dash.profit': 'Zysk / strata',
        ...
        en: {
            ...
            'form.beCheck': '💰 Check',
            'card.be': 'View value on BrickEconomy',
            'dash.marketValue': 'market value',
            'dash.compareTitle': 'Market vs purchase price',
            'dash.purchaseSum': 'Purchase prices total',
            'dash.marketSum': 'Market value',
            'dash.profit': 'Profit / loss',
