...
(function () {
    ...
    const translations = {
        pl: {
            ...
            'login.verifySubtitle': 'Sprawdź swoją skrzynkę i kliknij link weryfikacyjny',
            'login.verifyInfo': 'Wyśliśliśmy email z linkiem. Kliknij go w swojej skrzynce, a następnie wróć tutaj i naciśnij \u201eSprawdziłem maila\u201d.',
            'login.verifyBtn': 'Sprawdziłem maila ✓',
            'login.resendBtn': 'Wyślij link ponownie',
            ...
            'auth.registerSuccess': 'Konto utworzone! Wysłaliśmy link weryfikacyjny na Twój email.',
            'auth.regLinkSent': 'Konto utworzone! Wysłaliśmy link weryfikacyjny na Twój email.',
            'auth.notVerifiedYet': 'Email jeszcze niezweryfikowany — kliknij link z maila i spróbuj ponownie.',
            'auth.linkResent': 'Link weryfikacyjny wysłany ponownie! Sprawdź skrzynkę.',
            'auth.linkSentRelogin': 'Konto niezweryfikowane. Wysłaliśmy link na {email} — kliknij go i zaloguj się ponownie.',
            ...
            'buy.find': 'Znajdź:',
            'buy.browseStores': 'Przeglądaj sklepy',
            'buy.browseDesc': 'Szukaj przedmiotów w ulubionych sklepach',
            'buy.linksNewTab': '🔗 Linki otwierają się w nowej karcie',
            'buy.resultsVary': '💡 Wyniki wyszukiwania mogą się różnić w zależności od regionu',

            'kbd.title': 'Skróty klawiszowe',
            'kbd.helpNote': 'Naciśnij <kbd>?</kbd> w dowolnym momencie, aby wyświetlić tę pomoc',
            'kbd.newItem': 'Dodaj nowy element',
            'kbd.focusSearch': 'Przejdź do wyszukiwania',
            'kbd.focusSearchAlt': 'Przejdź do wyszukiwania (alt)',
            'kbd.gridView': 'Widok siatki',
            'kbd.listView': 'Widok listy',
            'kbd.toggleTheme': 'Przełącz tryb ciemny',
            'kbd.filterAll': 'Pokaż wszystkie',
            'kbd.filterOwned': 'Pokaż posiadane',
            'kbd.filterWishlist': 'Pokaż listę życzeń',
            'kbd.filterSold': 'Pokaż sprzedane',
            'kbd.showHelp': 'Pokaż tę pomoc',
            'kbd.closeModal': 'Zamknij modal/menu',

            'share.myCollection': 'MOJA KOLEKCJA',
            'share.totalItems': 'Liczba elementów',
            'share.themes': 'Motywy',
            'share.totalValue': 'Wartość',
            'share.topThemes': 'Top motywy:',
            'share.generatedWith': 'Wygenerowano w LEGO Collection Manager',
            'share.legoSets': 'Zestawy LEGO',
            'share.legoMinifigs': 'Minifigurki LEGO',
            'share.textBody': 'Sprawdź moją kolekcję: {type}! 🧱\n📊 {items} elementów\n💰 {value} łącznie\n🎨 {themes} różnych motywów\nZarządzane w LEGO Collection Manager #LEGO #Collection',
            'share.cardErr': 'Nie udało się wygenerować karty kolekcji: ',
            'share.qrErr': 'Nie udało się wygenerować kodu QR: ',
            'share.qrCanvasErr': 'Nie udało się wygenerować obrazu kodu QR',
            'share.html2canvasErr': 'Nie udało się załadować biblioteki html2canvas',
            'share.qrLibErr': 'Nie udało się załadować biblioteki QRCode',
            'share.unsupportedPlatform': 'Nieobsługiwana platforma: {p}',

            'dlg.noticeTitle': 'Informacja',
            'dlg.confirmTitle': 'Potwierdź',
            'dlg.ok': 'OK',
            'dlg.cancel': 'Anuluj',

            'mf.title': '🧑‍🚀 Figurki w tym zestawie',
            'mf.desc': 'Zestaw {set} zawiera {n} figurek. Zaznacz, które dodać do kolekcji minifigurek:',
            'mf.have': '(już w kolekcji)',
            'mf.addAll': 'Zaznacz wszystkie',
            'mf.add': 'Dodaj zaznaczone',
            'mf.skip': 'Pomiń',
            'mf.added': 'Dodano {n} figurek do kolekcji minifigurek.',
            'mf.none': 'Nie dodano żadnej figurki.',
            'mf.skipped': ' Pominięto {k} — już w kolekcji.',
            'mf.error': 'Nie udało się pobrać listy figurek.',
            'mf.fromSet': 'z zestawu {set}',
            'dash.title': '📊 Twoja kolekcja w liczbach',
            'dash.teaser': '📊 Statystyki kolekcji',
            'scan.btn': '📷 Skanuj',
            'scan.title': 'Skanowanie kodem',
            'scan.hint': 'Wyceluj w kod QR na pudełku (nowsze zestawy) lub kod zawierający numer',
            'scan.close': 'Zamknij',
            'scan.cameraError': 'Nie udało się uruchomić kamery.',
            'scan.cameraDenied': 'Brak dostępu do kamery — zezwól na ją w przeglądarce.',
            'scan.secureError': 'Kamera wymaga połączenia HTTPS (lub localhost).',
            'scan.libError': 'Nie udało się pobrać biblioteki skanera — sprawdź internet.',
            'scan.eanInfo': 'Zeskanowano kod produktu (EAN/UPC). Niestety żadne darmowe publiczne API nie mapuje kodów kreskowych LEGO na numery zestawów. Użyj kodu QR na pudełku (nowsze zestawy), wpisz numer ręcznie lub skorzystaj z ✨ Uzupełnij dane.',
            'scan.nothing': 'W zeskanowanym kodzie nie znaleziono numeru zestawu/figurki.',
            'scan.found': 'Rozpoznano numer: {n} — uzupełniam dane…',
            'dash.empty': 'Kolekcja jest jeszcze pusta — dodaj pierwszy zestaw, aby zobaczyć statystyki.',
            'dash.totalItems': 'elementów łącznie',
            'dash.totalValue': 'wartość kolekcji',
            'dash.totalPieces': 'klocków w zestawach',
            'dash.themesCount': 'różnych motywów',
            'dash.statusTitle': 'Podział po statusie',
            'dash.topThemesTitle': 'Najczęstsze motywy',
            'dash.yearsTitle': 'Elementy według roku wydania',
        ...
        en: {
            ...
            'login.verifySubtitle': 'Check your inbox and click the verification link',
            'login.verifyInfo': 'We sent you an email with a link. Click it in your inbox, then come back here and press \u201cI checked my email\u201d.',
            'login.verifyBtn': 'I checked my email ✓',
            'login.resendBtn': 'Resend link',
            ...
            'auth.registerSuccess': 'Account created! We sent a verification link to your email.',
            'auth.regLinkSent': 'Account created! We sent a verification link to your email.',
            'auth.notVerifiedYet': 'Email not verified yet — click the link from your inbox and try again.',
            'auth.linkResent': 'Verification link sent again! Check your inbox.',
            'auth.linkSentRelogin': 'Account not verified. We sent a link to {email} — click it and log in again.',
            ...
            'buy.find': 'Find:',
            'buy.browseStores': 'Browse Stores',
            'buy.browseDesc': 'Search for items in your favorite stores',
            'buy.linksNewTab': '🔗 Links open in new tab',
            'buy.resultsVary': '💡 Search results may vary by region',

            'kbd.title': 'Keyboard Shortcuts',
            'kbd.helpNote': 'Press <kbd>?</kbd> anytime to show this help',
            'kbd.newItem': 'Add new item',
            'kbd.focusSearch': 'Focus search',
            'kbd.focusSearchAlt': 'Focus search (alt)',
            'kbd.gridView': 'Grid view',
            'kbd.listView': 'List view',
            'kbd.toggleTheme': 'Toggle dark mode',
            'kbd.filterAll': 'Show all items',
            'kbd.filterOwned': 'Show owned',
            'kbd.filterWishlist': 'Show wishlist',
            'kbd.filterSold': 'Show sold',
            'kbd.showHelp': 'Show this help',
            'kbd.closeModal': 'Close modal/menu',

            'share.myCollection': 'MY COLLECTION',
            'share.totalItems': 'Total Items',
            'share.themes': 'Themes',
            'share.totalValue': 'Total Value',
            'share.topThemes': 'Top Themes:',
            'share.generatedWith': 'Generated with LEGO Collection Manager',
            'share.legoSets': 'LEGO Sets',
            'share.legoMinifigs': 'LEGO Minifigures',
            'share.textBody': 'Check out my {type} collection! 🧱\n📊 {items} items\n💰 {value} total value\n🎨 {themes} different themes\nManaged with LEGO Collection Manager #LEGO #Collection',
            'share.cardErr': 'Failed to generate collection card: ',
            'share.qrErr': 'Failed to generate QR code: ',
            'share.qrCanvasErr': 'Failed to generate QR code canvas',
            'share.html2canvasErr': 'Failed to load html2canvas library',
            'share.qrLibErr': 'Failed to load QRCode library',
            'share.unsupportedPlatform': 'Unsupported platform: {p}',

            'dlg.noticeTitle': 'Notice',
            'dlg.confirmTitle': 'Confirm',
            'dlg.ok': 'OK',
            'dlg.cancel': 'Cancel',

            'mf.title': '🧑‍🚀 Minifigures in this set',
            'mf.desc': 'Set {set} contains {n} minifigures. Pick which to add to your minifigures collection:',
            'mf.have': '(already in collection)',
            'mf.addAll': 'Select all',
            'mf.add': 'Add selected',
            'mf.skip': 'Skip',
            'mf.added': 'Added {n} minifigures to your collection.',
            'mf.none': 'No minifigures were added.',
            'mf.skipped': ' Skipped {k} — already in collection.',
            'mf.error': 'Failed to fetch the minifigure list.',
            'mf.fromSet': 'from set {set}',
            'dash.title': '📊 Your collection in numbers',
            'dash.teaser': '📊 Overall Statistics',
            'scan.btn': '📷 Scan',
            'scan.title': 'Scan a code',
            'scan.hint': 'Point at the QR code on the box (newer sets) or a code containing the number',
            'scan.close': 'Close',
            'scan.cameraError': 'Could not start the camera.',
            'scan.cameraDenied': 'Camera access denied — allow it in the browser.',
            'scan.secureError': 'Camera requires HTTPS (or localhost).',
            'scan.libError': 'Could not load the scanner library — check your connection.',
            'scan.eanInfo': 'Scanned a product barcode (EAN/UPC). Unfortunately no free public API maps LEGO barcodes to set numbers. Use the QR code on the box (newer sets), type the number manually, or use ✨ Auto-Fill.',
            'scan.nothing': 'No set/figure number found in the scanned code.',
            'scan.found': 'Recognized number: {n} — filling data…',
            'dash.empty': 'Your collection is still empty — add a first set to see stats.',
            'dash.totalItems': 'total items',
            'dash.totalValue': 'collection value',
            'dash.totalPieces': 'pieces in sets',
            'dash.themesCount': 'distinct themes',
            'dash.statusTitle': 'By status',
            'dash.topThemesTitle': 'Most frequent themes',
            'dash.yearsTitle': 'Items by release year',
